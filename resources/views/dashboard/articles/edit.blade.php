    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/articles/{{ $article->id }}" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" required value="{{ old('title', $article->title) }}">
              @error('title')
            ...
            <div class="mb-3">
                <label for="image" class="form-label @error('image') is-invalid @enderror">Article Image</label>
